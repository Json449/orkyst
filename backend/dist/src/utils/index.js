...
exports.twitterPrompt = twitterPrompt;
const blogPostPrompt = (title, audienceFocus, theme, date) => {
    return `
...
exports.linkedInPrompt = linkedInPrompt;
const defaultPrompt = (title, audienceFocus, theme, date, platform) => {
    return `
...
exports.generateCalendarPromptv1 = generateCalendarPromptv1;
